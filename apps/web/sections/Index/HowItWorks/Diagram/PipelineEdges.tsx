...
const PipelineEdges = ({ activeItem }: { activeItem: string }) => {
	return (
		<g>
			...
			<motion.path variants={VARIANTS} d="M270.5 226.4L284.161 226.4C288.579 226.4 292.161 229.982 292.161 234.4L292.161 314.998C292.161 319.416 295.743 322.998 300.161 322.998L309.5 322.998" stroke="#A5A5B620" strokeWidth={4} />
			...
			<motion.path variants={VARIANTS} d="M270.5 226.4L284.202 226.4C288.621 226.4 292.202 222.818 292.202 218.4L292.203 137.8C292.203 133.382 295.785 129.8 300.203 129.8L309.5 129.8" stroke="#A5A5B620" strokeWidth={4} />
			...
			<motion.path variants={VARIANTS} d="M270.5 97.5998L284.132 97.5999C288.55 97.6 292.132 101.182 292.132 105.6L292.132 121.8C292.132 126.218 295.714 129.8 300.132 129.8L309.5 129.8" stroke="#A5A5B620" strokeWidth={4} />
