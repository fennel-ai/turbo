...
@meta(owner="dataOncall@fennel.ai", tags=["PII"])
class User:
...
const Diagram = styled(motion.svg)`
	...
	.animated_edge {
		stroke: ${({ theme }) => rgba(theme.on_alt, 0.24)}; 
		stroke-width: 1.5;
		...
		<Root>
			<Diagram animate={showCode ? 'shown' : 'hidden'} variants={SVG_VARIANTS} ref={ref} width="740" height="453" viewBox="0 0 740 453" fill="none" xmlns="http://www.w3.org/2000/svg">
				<motion.g animate={`${activeItem}`} clipPath="url(#clip0_522_11836)">
					...
					{/** Separator */}
					<line x1="438" y1="2" x2="438" y2="451" stroke={theme.on_alt} strokeOpacity={0.16} stroke-width="2" stroke-linecap="square" stroke-dasharray="2 5" />
					{/** END Separator */}
				...
				<defs>
					...
					>
						<stop stopColor={theme.secondary.accent} stopOpacity="0" />
						<stop stopColor={theme.primary.accent} />
					...
					<filter id="filter5_b_522_11836" x="30" y="75" width="110" height="48" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
						<feFlood floodOpacity="0" result="BackgroundImageFix" />
					...
					<clipPath id="clip0_522_11836">
						<rect x="1" y="1" width="738" height="451" rx="16" fill="white" />
					</clipPath>
				</defs>
			</Diagram>
			...
			<ThemeProvider theme={themes[showCode ? 'dark' : theme.type]}>
