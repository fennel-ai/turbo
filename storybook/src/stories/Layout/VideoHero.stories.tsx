...
import { Video, Hero, getVideoOverlay} from 'ui';
    ...
    return (
        <div>
            ...
            >
                ...
                >
                    <div style={{width: "100%", padding: '20px', height: '100%'}}><Video url="https://www.youtube.com/watch?v=S8xk3E-Zvz4" getOverlay={getVideoOverlay}/></div>
                </div>
